...
from speedmon.common.exceptions import UnsupportedOperatingSystem
from speedmon.common.speedtest_cli_validation import check_for_speedtest_cli_windows, check_for_speedtest_cli, \
...
class Test(TestCase):
    ...
    def test_check_for_speedtest_cli_in_docker_check(self):
        ...
        result = check_for_speedtest_cli()
    ...
    @patch('speedmon.common.speedtest_cli_validation.os_name')
    ...
    @patch('speedmon.common.speedtest_cli_validation.os_name')
    @patch('speedmon.common.speedtest_cli_validation.check_for_speedtest_cli_windows')
    ...
    @patch('speedmon.common.speedtest_cli_validation.os_name')
    @patch('speedmon.common.speedtest_cli_validation.check_for_speedtest_cli_linux')
    ...
    @patch('speedmon.common.speedtest_cli_validation.subprocess.run')
